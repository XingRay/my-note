...
创建`.eslintignore`忽略不需要eslint检测的目录
...
```
 ...
 需要确保已经被git管理了, 如果没有被git管理, 按照下面的流程初始化git仓库
...
此时就可以在组件中使用 variables 中定义的变量了, 注意在 sass 中使用 `$` 符号定义变量
...
在项目的根目录下创建 mock 文件夹, 用于放置假接口, 文件名可自定义, 如:
...
![img](assets/02_项目搭建/1686227178484-fdb2adf8-f477-489c-a3ef-eade6593e2a6.png)
...
![img](assets/02_项目搭建/1686232739061-e85446e2-f124-4216-ac4a-28732f39d049.png)
...
![img](assets/02_项目搭建/1686652747135-0b5bcf74-4910-4a7b-9f9a-5f4aaf13143e.png)
...
![img](assets/02_项目搭建/1686657185142-e95a25b2-8b95-421c-a8a0-6fbf92128db4.png)
...
![img](assets/02_项目搭建/1686659094743-a0c09a96-a96f-4148-a151-e73edf6de081.png)
...
![img](assets/02_项目搭建/1686659170382-cea950a5-2caa-4a35-aad9-a03e2530219f.png)
...
![img](assets/02_项目搭建/1686664390737-aa104d68-baeb-4aaa-a8a6-bcb84cc6f706.png)
...
![img](assets/02_项目搭建/1686744570117-6b9c9476-bf26-44e9-84b4-d26e74991e08.png)
...
![img](assets/02_项目搭建/1686752090473-a473b998-3983-4d06-9140-37b6dac4583d.png)

![img](assets/02_项目搭建/1686752036717-5c1a5d51-e913-4354-9864-218ce9865c7c.png)
...
![img](assets/02_项目搭建/1686752189211-f804e379-6aa7-4920-aafe-5f041780cfc9.png)
...
![img](assets/02_项目搭建/1686752399349-cbc04664-8b9c-486f-bebf-65b7d817056d.png)

### 6.5 已有属性与属性值展示![img](assets/02_项目搭建/1686795418948-31d60c21-2a88-4aea-a65c-28c5f00de52d.png)
...
![img](assets/02_项目搭建/1686798316032-a933d5dd-d62b-488c-ae0a-c14c85d8d42a.png)
...
![img](assets/02_项目搭建/1686798425979-7d55099d-e2ab-421f-bb2d-4b59853867ab.png)

#### 6.6.2 表单

![img](assets/02_项目搭建/1686799137399-c9f28ead-b146-4662-bcb0-7573588765ff.png)

![img](assets/02_项目搭建/1686799153234-59a066c6-71b9-4199-83a4-dd7b019fdcdb.png)

#### 6.6.3 按钮 

![img](assets/02_项目搭建/1686799192838-9af18c3e-37a3-46bb-b897-207fbde8b310.png)

#### 6.6.4 表格

![img](assets/02_项目搭建/1686799235835-f775336d-5e9a-4c66-a8ff-7132353de35d.png)

#### 6.6.5按钮

![img](assets/02_项目搭建/1686799255431-f1448bb6-a978-48d6-b63f-c854b1dc6f8d.png)

#### 6.6.6 三级分类禁用

当点击添加属性之后，三级分类应该被禁用。因此使用props给子组件传参

![img](assets/02_项目搭建/1686799445308-549d6b42-410b-4425-a690-c9c1391008c2.png)

子组件：

二三级分类同理。

![img](assets/02_项目搭建/1686799463429-f5fa53aa-6a27-491d-9654-8072051a2d8a.png)

### 6.7 添加属性&&修改属性的接口类型

#### 6.7.1修改属性

![img](assets/02_项目搭建/1686800316360-3cf6deb0-9ed6-41e2-a3dd-6cfca638af27.png)

#### 6.7.2 添加属性

![img](assets/02_项目搭建/1686800346480-6ed0a403-5fa1-4ab9-9657-aadc998595a3.png)
...
![img](assets/02_项目搭建/1686814045000-bfe2d81f-7e0e-49ad-b100-84fac85cb5d8.png)

1. 属性值数组（attrValueList）

我们给添加属性值按钮绑定一个回调，点击的时候会往attrParams.attrValueList中添加一个空数组。我们根据空数组的数量生成input框，再将input的值与数组中的值绑定。

![img](assets/02_项目搭建/1686814119247-e54d7345-7455-4bc3-8d7e-80dd7c62d680.png)
...
![img](assets/02_项目搭建/1686814315880-8a46047d-801e-4e1b-a7d4-364790280d2b.png)
...
![img](assets/02_项目搭建/1686814617288-4eb94a14-1fbb-47f2-97d4-008ac83c5ede.png)

![img](assets/02_项目搭建/1686814630370-da0b9e15-deb7-49fd-af51-69f83e68236e.png)
...
![img](assets/02_项目搭建/1686818791856-f78d571a-e064-497a-ace9-2f77718cb509.png)
...
![img](assets/02_项目搭建/1686819053791-72d0b1e7-3c4f-49bf-8fec-e7d3a8632f03.png)
...
![img](assets/02_项目搭建/1686821046860-82d2b532-1c74-42f6-84f8-0ed05b2965d8.png)
...
![img](assets/02_项目搭建/1686821339268-94ce8cc1-b6a4-4e7d-927d-fe16d7deae18.png)
...
![img](assets/02_项目搭建/1686828008777-095b829a-1b63-4c3e-b962-5abb3155ee88.png)
...
![img](assets/02_项目搭建/1686829433684-3c282b3a-0e4b-43bf-aea5-9ab35f012ae0.png)
...
![img](assets/02_项目搭建/1686832530774-7f996dd6-1580-43f1-acce-4e136f8dfb45.png)
...
![img](assets/02_项目搭建/1686835072948-e6973dbb-2a66-4ca1-a5fc-4b3b8827b3f3.png)
...
![img](assets/02_项目搭建/1686903380491-bdaf014f-0279-41e4-8be5-594964f0d06b.png)

使用v-show来展示页面：v-if是销毁组件，v-show是隐藏组件。在初加载的时候v-if比较快，但是在频繁切换的时候v-if任务重。

![img](assets/02_项目搭建/1686903823284-077024da-55f4-4a04-9671-d066f5fa96be.png)

#### 7.3.2 SPU场景一子组件静态

![img](assets/02_项目搭建/1686903958378-c645a7b4-cdeb-47a5-89dd-824532793697.png)
...
![img](assets/02_项目搭建/1686904646717-171a2c5e-145c-44cf-9dc8-3bf1ef2a63a7.png)

子组件：

![img](assets/02_项目搭建/1686904669706-71eea879-11b3-4579-afb9-2c3384851997.png)
...
![img](assets/02_项目搭建/1686907112629-a376df3e-edd7-4ee6-b9db-2502dc34da98.png)
...
![img](assets/02_项目搭建/1686919439050-041158e1-17b4-4655-aaad-5ad59a35e579.png)

![img](assets/02_项目搭建/1686919450280-aa1620b9-9ca7-4d44-bf0a-126eaa67addc.png)

1. 子组件暴露对外函数

![img](assets/02_项目搭建/1686919498962-8129916e-d3f9-4e95-9f7f-b5f81a1f8c9b.png)

1. 修改按钮点击函数中调用子组件函数，并传递**第一部分数据**

![img](assets/02_项目搭建/1686919600667-51459837-9477-4a63-8556-b5f1b85f7203.png)
...
#### 7.7.2 展示SPU名称
 ...
 ![img](assets/02_项目搭建/1686922904926-5dcdf523-c184-445d-a5e4-1661321e54aa.png)

#### 7.7.3 展示SPU品牌

注意：下方的红框展示的是所有品牌，上方的绑定的是一个数字也就是下方的第几个

![img](assets/02_项目搭建/1686922965037-e796b44f-ab15-42bf-9c3a-3523e314d104.png)

#### 7.7.4 SPU描述

![img](assets/02_项目搭建/1686923031230-7dc16295-2f66-4b9e-bed3-847e8bd34821.png)
...
![img](assets/02_项目搭建/1686988494877-55e9509a-d3c4-467c-8246-53cd4ffcaa7f.png)

上面el-upload是上传照片的照片墙，下面是查看照片的对话框

1. **v-model:file-list**

![img](assets/02_项目搭建/1686988626784-43a4991e-d407-429d-822f-88830286af4d.png)
...
![img](assets/02_项目搭建/1686989045383-ef42833b-0e80-49b6-a29f-a3c2ce877064.png)

1. **list-type：照片墙的形式**

![img](assets/02_项目搭建/1686989259679-ef9a5ffc-e726-4885-a8cf-49a4c9d3ea48.png)

1. **:on-preview**

预览的钩子，预览照片时会触发。会注入对应图片的数据。

![img](assets/02_项目搭建/1686989368164-6c2ce0fe-b51e-4ca7-b8ca-9589b7ba96d2.png)

![img](assets/02_项目搭建/1686989430744-e1caacd1-69cd-49cf-9343-14b736dcffc9.png)
...
![img](assets/02_项目搭建/1686993563772-6b6632e2-b182-48d8-9f55-6bbb09b19810.png)
...
![img](assets/02_项目搭建/1686993655487-091d9f81-5a74-439d-894b-ea8eef509f1d.png)
...
![img](assets/02_项目搭建/1686994378002-043870be-eff0-4074-a34d-ab25e794a987.png)

#### 7.9.2 收集你选择的属性的id以及name

![img](assets/02_项目搭建/1686994473412-92557912-3f9d-4e14-a735-bb0f1c12591a.png)

#### 7.9.3 添加属性按钮的回调

![img](assets/02_项目搭建/1686994600494-75195d20-80fc-4a6f-8a5e-6bfd10947a6b.png)
...
![img](assets/02_项目搭建/1687003902440-fde95310-86b0-4a99-8385-aaa68b3b5fc8.png)
...
![img](assets/02_项目搭建/1687004007812-05a1ad0f-c1c0-4979-b8d0-e71d95ab70a3.png)
...
![img](assets/02_项目搭建/1687004198221-c62b2302-2969-4d81-859e-e81da3172ad0.png)
...
![img](assets/02_项目搭建/1687079226608-43b874b9-95ab-4fc5-92b4-7c39ddb19d33.png)

#### 7.14.1 绑定回调

![img](assets/02_项目搭建/1687079274115-0000c313-172e-4244-8d6c-2f83faf1bd94.png)
...
![img](assets/02_项目搭建/1687093072553-ab3ac218-f1b5-4ef5-b777-a90197d6f5a5.png)![img](assets/02_项目搭建/1687093081966-b292bc30-c696-4169-ba21-9d7e3ea01339.png)![img](assets/02_项目搭建/1687093092853-3cf1cecf-3b52-4071-b0b1-6ba7035d7a84.png)

![img](assets/02_项目搭建/1687093104649-4aad390d-6ec0-4962-b952-aa64a4513a51.png)

#### 7.16.4 收集平台属性以及销售属性

![img](assets/02_项目搭建/1687097622172-46a81217-0227-4c1f-9c53-e3df70affb75.png)

我们在数据绑定的时候将这俩个属性所选择的数据绑定到自身。之后整合数据的时候通过遍历得到

#### 7.16.5 img 数据&&设置默认图片

![img](assets/02_项目搭建/1687097703539-6f61443d-f7f1-48bd-85aa-008610ff46db.png)
...
![img](assets/02_项目搭建/1687146441257-0cbf27db-8449-45bf-bd88-f414e9e3a363.png)
...
![img](assets/02_项目搭建/1687146586392-c74667f5-ca64-46a6-8cf8-be689e7ccf79.png)
...
![img](assets/02_项目搭建/1687159314422-b8d2df10-2984-412a-9d99-8e30a36792d7.png)
...
![img](assets/02_项目搭建/1687159421148-6f7ae443-cede-4d78-9443-dcda5939bf12.png)
...
![img](assets/02_项目搭建/1687163313767-8f3cd30b-f748-43da-abd4-970a6c7365ec.png)
...
![img](assets/02_项目搭建/1687164359083-891278ac-9b8f-4574-a722-f96b57e318e2.png)

![img](assets/02_项目搭建/1687164386136-be40cb86-f189-4d92-841a-fac80733737f.png)
...
![img](assets/02_项目搭建/1687164477778-6b4f8be8-4681-4578-bcfb-9b31fcc3e14c.png)
...
![img](assets/02_项目搭建/1687164604634-6048bc62-387a-40ed-8e2a-3bca1e47a670.png)

![img](assets/02_项目搭建/1687164669076-3b077e0a-25fb-4b89-b117-89509ec395f8.png)
...
![img](assets/02_项目搭建/1687176061206-d2f80a8c-44e9-4ba9-b1fd-9fcf4ca33cc0.png)
...
![img](assets/02_项目搭建/1687176170191-a30b115b-4525-404d-97f9-2816ea581410.png)

![img](assets/02_项目搭建/1687176245175-67a00c7a-22c1-4b2e-bb8c-02a87cbb55f1.png)
...
![img](assets/02_项目搭建/1687176353593-48f66767-a6d6-40cc-a39b-6881d660298f.png)

![img](assets/02_项目搭建/1687176364246-6d9da9f0-16bf-40a1-933a-00b35d66c069.png)、

**效果图：**

![img](assets/02_项目搭建/1687176376524-0e447d4f-dea0-4a01-b730-c747636e9b9c.png)

#### 8.5.3 轮播图 carousel

![img](assets/02_项目搭建/1687176440042-47df1ed1-9120-4d52-8f89-e7f47df2c773.png)

注意：把对应的style也复制过来

![img](assets/02_项目搭建/1687176475504-40320516-753b-453d-9c17-a7f41b08af4f.png)
...
![img](assets/02_项目搭建/1687177242956-2d65bd42-2c66-49e8-a719-dd40427a0fc2.png)
...
![img](assets/02_项目搭建/1687183115552-2fdcbed1-746e-43a4-8197-5fdf7982ec89.png)

#### 9.2.4 分页器俩个函数回调

![img](assets/02_项目搭建/1687183149328-38648116-809f-4e2e-a4b2-23f7482a5171.png)
...
![img](assets/02_项目搭建/1687184024153-e5635f85-12fd-4ab3-87c4-a4d2f9f4dcbe.png)
...
![img](assets/02_项目搭建/1687230271938-ec0a2555-ca65-48c6-bae7-84aba670d7f6.png)
...
![img](assets/02_项目搭建/1687230521884-81f060ac-8ad7-4141-8b94-363bf5c54268.png)
...
![img](assets/02_项目搭建/1687231969099-324f22f3-1474-4fa2-93de-e396d37f1d1a.png)
...
![img](assets/02_项目搭建/1687232470776-e7a5fc68-5ab0-466f-ae71-d1d1a2ea7be4.png)
...
![img](assets/02_项目搭建/1687244120015-e2e4af53-0a0f-42ce-9b83-8ac5f2a4f8fe.png)
...
![img](assets/02_项目搭建/1687247734206-078d2ebc-9931-4a1b-b3c9-5997a03fe4c1.png)

![img](assets/02_项目搭建/1687247819876-9af62652-24e9-43c1-9f27-87308549fbf7.png)

#### 9.6.1 其余工作

1. 添加按钮回调

![img](assets/02_项目搭建/1687247903718-0c536c38-c15d-40d6-b93d-dbe3fc4efc59.png)
...
首先，当你更改当前账号再刷新的时候，浏览器还是会往当前页面跳转![img](assets/02_项目搭建/1687250494483-8ceaa384-1bf7-46e3-87d6-58a0d633f2bb.png)

这时候路由前置守卫就会发生作用：

![img](assets/02_项目搭建/1687250671076-d48a168d-67f0-4a5a-89d2-9c6ab8c4a8c8.png)

你会发现，此时你的token存储在本地存储里面，所以是有的，username存储在仓库里面，所以刷新就没了。这也是之前说的仓库存储的问题。此时你的路由守卫就会走到下面这部分

![img](assets/02_项目搭建/1687250778589-38c56fc5-47bc-4813-a94b-add3a77fd9a2.png)
...
![img](assets/02_项目搭建/1687251054964-165fc6f5-fb64-4613-96a2-2c257fa7f626.png)

登陆后再修改：

![img](assets/02_项目搭建/1687251096919-1a8de21a-95e9-4555-a953-d91ffcedb7da.png)

跳转到了login界面

![img](assets/02_项目搭建/1687251119428-18edf787-a6d4-4fc4-bb94-0db5ddf0c198.png)

此时来看一下仓库：token和username都没了。这是为什么呢？

![img](assets/02_项目搭建/1687251152186-30a2743c-dda5-4571-b788-408e0aeaff4e.png)
...
![img](assets/02_项目搭建/1687251285241-b5ff1d14-a613-451f-9aed-0dd65a98dbc7.png)



**补充:证明一下我们修改了账户之后服务器会阻止我们登录。**

![img](assets/02_项目搭建/1687251635584-95feb10e-286e-4bc7-b5b3-d56754ce4395.png)

此时修改一下路由守卫（做个标记）

![img](assets/02_项目搭建/1687252285483-7302507a-91c9-4751-a4e9-dbb9f1049a13.png)

刷新一下，证明路由确实是从这走的

![img](assets/02_项目搭建/1687252310776-3b31d70f-dd25-4f2b-acd0-03255d79984c.png)

此时在修改路由守卫以及用户信息方法

![img](assets/02_项目搭建/1687252489079-28c072eb-7537-412b-a79f-23012ad3ab4e.png)

![img](assets/02_项目搭建/1687252509370-a428ccbf-fb6c-42ff-b2d2-17afb0b649f5.png)

修改完之后再发请求：

![img](assets/02_项目搭建/1687252569964-bf8fac02-6259-4ee9-b729-4566ac75a8ce.png)
...
![img](assets/02_项目搭建/1687265245715-9c530985-6a07-4b5b-a4cb-7de104293fb8.png)
...
![img](assets/02_项目搭建/1687268243753-2e5f979c-ddec-4b03-a767-7734beabb82f.png)
...
![img](assets/02_项目搭建/1687268744003-295c3c73-2183-4644-b8a5-69c92dfb3405.png)
...
![img](assets/02_项目搭建/1687270882880-47dfab03-f72d-4a9c-90d4-61f81bb85904.png)
...
![img](assets/02_项目搭建/1687270952856-368678be-fb6f-4c2a-8830-111b98a0d3ae.png)

1. table收集选中的数据

![img](assets/02_项目搭建/1687270977030-9d5ca461-8beb-4162-a2d6-fda8cf72f0d1.png)
...
![img](assets/02_项目搭建/1687271941528-28e59b25-a8e8-41c1-a485-9e09bde72cb0.png)

发送请求

![img](assets/02_项目搭建/1687271960218-eaa54ae7-cfe3-4f93-9264-68a75da2e14b.png)
...
![img](assets/02_项目搭建/1687331832132-0aa2a7f3-4e5b-470f-a2b5-8055f5c68ec2.png)

![img](assets/02_项目搭建/1687331845777-d679e50b-cf7f-46fe-bb7c-d3d12992013b.png)
...
![img](assets/02_项目搭建/1687331886664-a0145e31-fc38-44a1-a199-b95560fa78ef.png)
...
![img](assets/02_项目搭建/1687335814730-501a9711-292c-461d-a284-61252090c733.png)

![img](assets/02_项目搭建/1687335834449-a0f1be84-f7a8-4196-9d59-4c3ee517d449.png)
...
![img](assets/02_项目搭建/1687336016429-e93862c4-0722-4891-b82b-a1c44e29a237.png)
...
![img](assets/02_项目搭建/1687347648119-02f1c31a-a7dc-4505-bfef-5191ee5914e3.png)
...
![img](assets/02_项目搭建/1687347742748-87c11f71-32aa-4d50-8cf0-d47e5bf003d7.png)
...
![img](assets/02_项目搭建/1687422831967-dcbe8bdd-f11d-455c-8f41-e4c2121f225b.png)

#### 13.1.2 暗黑模式

![img](assets/02_项目搭建/1687423099603-5d044dc9-3e01-4e87-a27f-fa87e3d31f46.png)
...
![img](assets/02_项目搭建/1687423948635-c1eab659-93da-4a90-b5dc-16854b9aaaf9.png)
...
![img](assets/02_项目搭建/1687424147408-47ac07fa-4a7c-4337-a7da-8b911f5a6ff4.png)
...
![img](assets/02_项目搭建/1687677986213-04c71a4d-4a74-4143-9c37-559326865f89.png)
...
![img](assets/02_项目搭建/1687677975466-f78ff6b1-05c1-4b95-81c6-8b854fd5fdf2.png)

#### 14.2.3 顶部按钮

![img](assets/02_项目搭建/1687678431746-76eee1d4-5d75-4806-b603-9a74b1cbb39f.png)
...
![img](assets/02_项目搭建/1687680105064-05bec5b0-91ba-40d3-b66e-9a71ee918f50.png)
...
注意：在“可预约总量99999人”那里使用了`float: right;`，float对上面的块级元素不会产生影响，因此不会飘上去。
...
![img](assets/02_项目搭建/1687683692139-d97eab8c-262d-4994-a43a-12dfe1132ae0.png)
...
![img](assets/02_项目搭建/1687696783303-4752e563-9132-45e5-894b-3db6f58d3af6.png)
...
![img](assets/02_项目搭建/1687871811884-0fde9beb-8052-43e5-b902-ff23dea99493.png)
...
![img](assets/02_项目搭建/1687873091567-91965f46-08f9-468b-9361-c2525b9368a9.png)
...
![img](assets/02_项目搭建/1687874884040-4711f87b-73ec-485d-a5aa-97586559b774.png)
