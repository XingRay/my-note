...
在 GitHub 上可以[获取](https://github.com/bazelbuild/examples)到这些示例。为了运行这些案例，需要对系统进行以下配置。

- Windows 系统：[安装 Bazel](https://docs.bazel.build/versions/main/install-windows.html)，安装 MSVC，安装 Windows SDK ([详细说明](https://docs.bazel.build/versions/main/windows.html))
- Ubuntu 系统：[安装 Bazel](https://docs.bazel.build/versions/main/install-ubuntu.html)，以下命令可能会有所帮助：
