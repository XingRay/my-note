...
- libhv：一个类似libevent、libuv的跨平台事件循环库，提供了更简单的API接口和更丰富的协议。[官网](https://github.com/ithewei/libhv)
...
- MySQL++：封装了MySql的C API的C++ 包装器。[官网](http://www.tangentsoft.net/mysql%2B%2B/)
...
- 静态代码分析工具清单（[开源篇](http://hao.jobbole.com/static_code_analysis_tool_list_opensource/)）：来自维基百科的静态代码分析工具列表。[官网](http://en.wikipedia.org/wiki/List_of_tools_for_static_code_analysis%23C.2FC.2B.2B)
