...
前面文章[一文掌握 YUV 图像的基本处理](http://mp.weixin.qq.com/s?__biz=MzIwNTIwMzAzNg==&mid=2654161519&idx=1&sn=4b6c436c988fa31458c89228924d8d76&chksm=8cf3995cbb84104a7830edbedcc8a44b1b72b31fc0957b55bb98a9b2babc01c469f541d29abb&scene=21#wechat_redirect)介绍了 YUV 常用的基本格式，本文以实现 NV21/NV12 的渲染为例。

前文提到，YUV 图不能直接用于显示，需要转换为 RGB 格式，而 YUV 转 RGB 是一个逐像素处理的耗时操作，在 CPU 端进行转换效率过低，这时正好可以利用 GPU 强大的并行处理能力来实现 YUV 到 RGB 的转换。

YUV 与 RGB 之间的转换公式。

![图片](assets/003_YUV 渲染/640.png)YUV 与 RGB 之间的转换公式

![图片](assets/003_YUV 渲染/640-1702031296710-14.jpeg)YUV 与 RGB 之间的转换矩阵
...
![图片](assets/003_YUV 渲染/640-1702031296711-15.png)OpenGLES 常用纹理的格式类型
...
![图片](assets/003_YUV 渲染/640-1702031296711-16.gif)
