...
其中，**#version 300 es** 为 OpenGLES 3.0 版本声明，3.0 中使用 **in** 和 **out** 关键字取代 **attribute** 和 **var****ying** ，**layout** 关键字直接为脚本中的属性指定位置，为属性赋值变成了：
...
![图片](assets/001_绘制一个三角形/640.jpeg)opengles 坐标系中三角形顶点坐标

![图片](assets/001_绘制一个三角形/640-1702031225098-1.jpeg)绘制的结果图
