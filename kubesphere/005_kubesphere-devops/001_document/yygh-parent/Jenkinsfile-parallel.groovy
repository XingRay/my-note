    ...
    stages {
                    ...
                    steps {
                        container('maven') {
                            withCredentials([usernamePassword(credentialsId: 'harbor-robot-test', passwordVariable: 'REGISTRY_PASSWORD', usernameVariable: 'REGISTRY_USERNAME',)]) {
                                ...
                                sh 'podman push  $REGISTRY/$REGISTRY_NAMESPACE/server-gateway:SNAPSHOT-$BUILD_NUMBER'
                            }
                        }
                    }
                }
                    ...
                    steps {
                        container('maven') {
                            withCredentials([usernamePassword(credentialsId: 'harbor-robot-test', passwordVariable: 'REGISTRY_PASSWORD', usernameVariable: 'REGISTRY_USERNAME',)]) {
                                ...
                                sh 'podman push  $REGISTRY/$REGISTRY_NAMESPACE/service-cmn:SNAPSHOT-$BUILD_NUMBER'
                            }
                        }
                    }
                }
                    ...
                    steps {
                        container('maven') {
                            withCredentials([usernamePassword(credentialsId: 'harbor-robot-test', passwordVariable: 'REGISTRY_PASSWORD', usernameVariable: 'REGISTRY_USERNAME',)]) {
                                ...
                                sh 'podman push  $REGISTRY/$REGISTRY_NAMESPACE/service-hosp:SNAPSHOT-$BUILD_NUMBER'
                            }
                        }
                    }
                }
                    ...
                    steps {
                        container('maven') {
                            withCredentials([usernamePassword(credentialsId: 'harbor-robot-test', passwordVariable: 'REGISTRY_PASSWORD', usernameVariable: 'REGISTRY_USERNAME',)]) {
                                ...
                                sh 'podman push  $REGISTRY/$REGISTRY_NAMESPACE/service-order:SNAPSHOT-$BUILD_NUMBER'
                            }
                        }
                    }
                }
                    ...
                    steps {
                        container('maven') {
                            withCredentials([usernamePassword(credentialsId: 'harbor-robot-test', passwordVariable: 'REGISTRY_PASSWORD', usernameVariable: 'REGISTRY_USERNAME',)]) {
                                ...
                                sh 'podman push  $REGISTRY/$REGISTRY_NAMESPACE/service-oss:SNAPSHOT-$BUILD_NUMBER'
                            }
                        }
                    }
                }
                ...
                stage('推送镜像-service-sms') {
                    ...
                    steps {
                        container('maven') {
                            withCredentials([usernamePassword(credentialsId: 'harbor-robot-test', passwordVariable: 'REGISTRY_PASSWORD', usernameVariable: 'REGISTRY_USERNAME',)]) {
                                sh 'echo $REGISTRY_PASSWORD | podman login  $REGISTRY --username=$REGISTRY_USERNAME --password-stdin'
                                sh 'podman tag service-sms:latest $REGISTRY/$REGISTRY_NAMESPACE/service-sms:SNAPSHOT-$BUILD_NUMBER'
                                sh 'podman push $REGISTRY/$REGISTRY_NAMESPACE/service-sms:SNAPSHOT-$BUILD_NUMBER'
                            }
                        }
                    }
                }
                    ...
                    steps {
                        container('maven') {
                            withCredentials([usernamePassword(credentialsId: 'harbor-robot-test', passwordVariable: 'REGISTRY_PASSWORD', usernameVariable: 'REGISTRY_USERNAME',)]) {
                                ...
                                sh 'podman push  $REGISTRY/$REGISTRY_NAMESPACE/service-statistics:SNAPSHOT-$BUILD_NUMBER'
                            }
                        }
                    }
                }
                    ...
                    steps {
                        container('maven') {
                            withCredentials([usernamePassword(credentialsId: 'harbor-robot-test', passwordVariable: 'REGISTRY_PASSWORD', usernameVariable: 'REGISTRY_USERNAME',)]) {
                                ...
                                sh 'podman push  $REGISTRY/$REGISTRY_NAMESPACE/service-task:SNAPSHOT-$BUILD_NUMBER'
                            }
                        }
                    }
                }
                    ...
                    steps {
                        container('maven') {
                            withCredentials([usernamePassword(credentialsId: 'harbor-robot-test', passwordVariable: 'REGISTRY_PASSWORD', usernameVariable: 'REGISTRY_USERNAME',)]) {
                                ...
                                sh 'podman push  $REGISTRY/$REGISTRY_NAMESPACE/service-user:SNAPSHOT-$BUILD_NUMBER'
                            }
                        }
                    }
                }
        ...
        stage('部署到生产环境') {
            parallel {
                ...
                stage('部署到生产环境-service-statistics') {
                    steps {
                        container('maven') {
                            withCredentials([kubeconfigFile(credentialsId: env.KUBECONFIG_CREDENTIAL_ID, variable: 'KUBECONFIG')]) {
