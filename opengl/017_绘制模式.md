...
大家好，下面和大学一起学习绘制模式，在我的github上有一个项目`OpenGLES2.0SamplesForAndroid`，我会不断地编写学习样例，文章和代码同步更新，欢迎关注，链接：[github.com/kenneycode/…](https://link.juejin.cn?target=https://github.com/kenneycode/OpenGLES2.0SamplesForAndroid)
...
代码在我github的`OpenGLES2.0SamplesForAndroid`项目中，本文对应的是`SampleDrawMode`，项目链接：[github.com/kenneycode/…](https://link.juejin.cn?target=https://github.com/kenneycode/OpenGLES2.0SamplesForAndroid)
