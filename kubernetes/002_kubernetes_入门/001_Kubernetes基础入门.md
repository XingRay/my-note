...
![部署演进](assets/001_Kubernetes基础入门/container_evolution.svg)
...
![img](assets/001_Kubernetes基础入门/9e637c54459c61c8f1879c3527f9b78a.png)



##### 2 服务编排

![img](assets/001_Kubernetes基础入门/4da21bc4c1cda04e485b335100ae02b3.png-wh_600x-s_704737526.png)
...
![1619061915065](assets/001_Kubernetes基础入门/1619061915065.png)
...
![Kubernetes 组件](assets/001_Kubernetes基础入门/components-of-kubernetes.svg)
...
![1619075196642](assets/001_Kubernetes基础入门/1619075196642.png)
...
![1619062152511](assets/001_Kubernetes基础入门/1619062152511.png)
...
![1619062201206](assets/001_Kubernetes基础入门/1619062201206.png)
...
![1619076211983](assets/001_Kubernetes基础入门/1619076211983.png)
...
![1619100578888](assets/001_Kubernetes基础入门/1619100578888.png)
...
![1619265256236](assets/001_Kubernetes基础入门/1619265256236.png)
...
![1619265364639](assets/001_Kubernetes基础入门/1619265364639.png)





![1619265568111](assets/001_Kubernetes基础入门/1619265568111.png)
...
sed -i 's/PermitRootLogin prohibit-password/PermitRootLogin yes/gi' /etc/ssh/sshd_config
...
```shell
sudo apt install -y vim wget net-tools selinux-utils ntp ipvsadm ipset curl gnupg2 software-properties-common apt-transport-https ca-certificates
```
...
echo "fs.inotify.max_user_instances = 624288" >> /etc/sysctl.conf
...
echo "192.168.0.151 cluster-endpoint" >> /etc/hosts
...
第四步，用控制台打印的kubeadm join 去其他worker节点执行

```shell
kubeadm join cluster-endpoint:6443 --token 3yrusv.8qvl99czbnjqrz4q \
        --discovery-token-ca-cert-hash sha256:3a9515d450251981d39f2aa7e0296ecf89935ee41ea376e997ad12cdcff7059a
```
...
![Kubernetes集群](assets/001_Kubernetes基础入门/module_01.f6dc9f93.svg)
...
![基础知识](assets/001_Kubernetes基础入门/module_01_cluster.8f54b2c5.svg)
...
![img](assets/001_Kubernetes基础入门/module_02_first_app.svg)
...
![Pod概念](assets/001_Kubernetes基础入门/module_03_pods.ccc5ba54.svg)
...
![Node概念](assets/001_Kubernetes基础入门/module_03_nodes.38f0ef71.svg)
...
![img](assets/001_Kubernetes基础入门/module_04_services.svg)
...
![img](assets/001_Kubernetes基础入门/module_04_labels.svg)
...
![1619086037936](assets/001_Kubernetes基础入门/1619086037936.png)
...
![img](assets/001_Kubernetes基础入门/module_06_rollingupdates1.svg)



![img](assets/001_Kubernetes基础入门/module_06_rollingupdates2.svg)



![img](assets/001_Kubernetes基础入门/module_06_rollingupdates3.svg)



![img](assets/001_Kubernetes基础入门/module_06_rollingupdates4.svg)
...
下载另存为 kubernetes-dashboard_v2.7.0.yaml 并上传至服务器, 需要做修改
...
添加 : `type: NodePort`,  另存为 `kubernetes-dashboard_v2.7.0-nodeport.yaml`

安装 dashboard

```shell
kubectl apply -f kubernetes-dashboard_v2.7.0-nodeport.yaml
```

安装完成后查看 service 的 NodePort 端口
...
```shell
kubernetes-dashboard   kubernetes-dashboard        NodePort    10.96.40.59    <none>        443:31822/TCP            5m27s
```

集群外可以通过访问集群任意节点的 31822 端口访问, https://192.168.0.151:31822/ ,登录需要 token, 下面生成 token

准备一个yaml文件：

```bash
vi kubernetes-dashboard-account.yaml
```
...
在登录页选择token，在输入框中输入上面产生的token即可登录进dashboard了。
