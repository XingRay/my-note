...
raw 关键字做后缀 ( 例如 /dev/hdb1:20Gnewraw 或 /dev/hdb1:20Graw); MySQL 4.0 及更高版本的默认设置是 ibdata1![:10M:](https://www.webpagefx.com/tools/emoji-cheat-sheet/graphics/emojis/10M.png)autoextend 。
