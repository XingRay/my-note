...
[jenkins](https://so.csdn.net/so/search?q=jenkins&spm=1001.2101.3001.7020) 有 2 种流水线分为声明式流水线与脚本化流水线，脚本化流水线是 jenkins 旧版本使用的流水线脚本，新版本 Jenkins 推荐使用声明式流水线。文档只介绍声明流水线。

### 1.1 声明式流水线

在声明式流水线语法中，流水线过程定义在 [Pipeline](https://so.csdn.net/so/search?q=Pipeline&spm=1001.2101.3001.7020){}中，Pipeline 块定义了整个流水线中完成的所有工作，比如
