...
添加环境变量 `WIONDOWS_KIT_HOME` 

```cmd
C:\Program Files (x86)\Windows Kits\10\bin\10.0.22000.0\x64
```

添加到系统Path `$WIONDOWS_KIT_HOME$`，测试：
...
```shell
java --module-path target\classes --module com.xingray.javafx.graalvm/com.xingray.javafx.graalvm.Launcher
```

```shell
Error occurred during initialization of boot layer
java.lang.module.FindException: Module javafx.controls not found, required by com.xingray.javafx.graalvm
```
...
```shell
java --module-path target\classes;output\dependency --class-path output\dependency --module com.xingray.javafx.graalvm/com.xingray.javafx.graalvm.Launcher
```
...
下面通过 java-agent 生成应用的反射信息, 执行命令启动应用:

```shell
java -agentlib:native-image-agent=config-output-dir=src\main\resources\META-INF\native-image --module-path target/classes;D:\develop\maven\repository\org\openjfx\javafx-base\20.
0.2\javafx-base-20.0.2.jar;D:\develop\maven\repository\org\openjfx\javafx-base\20.0.2\javafx-base-20.0.2-win.jar;D:\develop\maven\repository\org\openjfx\javafx-graphics\20.0.2\javafx-graphics-20.0.2.jar;D:\develop\maven
\repository\org\openjfx\javafx-graphics\20.0.2\javafx-graphics-20.0.2-win.jar;D:\develop\maven\repository\org\openjfx\javafx-controls\20.0.2\javafx-controls-20.0.2.jar;D:\develop\maven\repository\org\openjfx\javafx-cont
rols\20.0.2\javafx-controls-20.0.2-win.jar;D:\develop\maven\repository\org\openjfx\javafx-fxml\20.0.2\javafx-fxml-20.0.2.jar;D:\develop\maven\repository\org\openjfx\javafx-fxml\20.0.2\javafx-fxml-20.0.2-win.jar --module
 com.xingray.graalvm.javafx/com.xingray.graalvm.javafx.Launcher
```

反复操作几次应用,尽量测试各种功能, 此时会在指定的目录 `src\main\resources\META-INF\native-image` 生成反射信息



编译, 注意要通过 `--add-modules ` 指令添加依赖的模块和通过 `--module-path` 指令指定模块所在路径

```shell
native-image --no-fallback --add-modules javafx.base,javafx.graphics,javafx.controls,javafx.fxml --module-path target/classes;D:\develop\maven\repository\org\openjfx\javafx-base\20.0.2\javafx-base-20.0.2.jar;D:\develop\maven\repository\org\openjfx\javafx-base\20.0.2\javafx-base-20.0.2-win.jar;D:\develop\maven\repository\org\openjfx\javafx-graphics\20.0.2\javafx-graphics-20.0.2.jar;D:\develop\maven\repository\org\openjfx\javafx-graphics\20.0.2\javafx-graphics-20.0.2-win.jar;D:\develop\maven\repository\org\openjfx\javafx-controls\20.0.2\javafx-controls-20.0.2.jar;D:\develop\maven\repository\org\openjfx\javafx-controls\20.0.2\javafx-controls-20.0.2-win.jar;D:\develop\maven\repository\org\openjfx\javafx-fxml\20.0.2\javafx-fxml-20.0.2.jar;D:\develop\maven\repository\org\openjfx\javafx-fxml\20.0.2\javafx-fxml-20.0.2-win.jar --module com.xingray.graalvm.javafx/com.xingray.graalvm.javafx.Launcher -o app
```



不添加 `--add-modules` 也可以编译(无法运行)

```shell
native-image --no-fallback --module-path target/classes;D:\develop\maven\repository\org\openjfx\javafx-base\20.0.2\javafx-base-20.0.2.jar;D:\develop\maven\repository\org\openjfx\javafx-base\20.0.2\javafx-base-20.0.2-win.jar;D:\develop\maven\repository\org\openjfx\javafx-graphics\20.0.2\javafx-graphics-20.0.2.jar;D:\develop\maven\repository\org\openjfx\javafx-graphics\20.0.2\javafx-graphics-20.0.2-win.jar;D:\develop\maven\repository\org\openjfx\javafx-controls\20.0.2\javafx-controls-20.0.2.jar;D:\develop\maven\repository\org\openjfx\javafx-controls\20.0.2\javafx-controls-20.0.2-win.jar;D:\develop\maven\repository\org\openjfx\javafx-fxml\20.0.2\javafx-fxml-20.0.2.jar;D:\develop\maven\repository\org\openjfx\javafx-fxml\20.0.2\javafx-fxml-20.0.2-win.jar --module com.xingray.graalvm.javafx/com.xingray.graalvm.javafx.Launcher -o app
```



创建文件 native-image.args
...
native-image --no-fallback --module-path target/classes;output/dependency --module com.xingray.graalvm.javafx/com.xingray.graalvm.javafx.Launcher -o app
```



```shell
PS D:\code\study\java\graalvm\graalvm-javafx> .\app.exe
Launcher#main:
...
```cmd
.\app.exe -Djavafx.verbose=true -Dprism.verbose=true
```
