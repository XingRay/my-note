...
- **Image updates**:
  [official-images repo's `library/rabbitmq` label](https://github.com/docker-library/official-images/issues?q=label:library/rabbitmq)
...
![logo](assets/002_dockerhub文档/logo.png)
