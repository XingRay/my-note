...
在本篇中，非常简单，我们只有一个Descriptor，并且他就是binding point = 0，如果把他看做一个array，我们要写入的就是他的[0号元素](https://zhida.zhihu.com/search?content_id=190373268&content_type=Article&match_order=1&q=0号元素&zhida_source=entity)。
