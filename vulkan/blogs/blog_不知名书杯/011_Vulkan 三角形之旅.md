...
> 这里是记录笔者Vulkan的学习记录，参照该教程[Introduction - Vulkan Tutorial](https://vulkan-tutorial.com/Introduction)。如果你想识别Vulkan相比于之前的传统图形API有什么区别和优势的话，欢迎看我的另外一篇文章[初探Vulkan](https://zhuanlan.zhihu.com/p/554631289)。相信应该能够帮助你识别Vulkan的优势所在。
